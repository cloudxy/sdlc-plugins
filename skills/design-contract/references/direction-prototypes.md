...
| Design direction | designer `explore` | `02-shape/prototypes/D<n>/` | Clickable main journey to the Aha moment, real copy, screenshots at 375 and 1440 with no visible defects |
...
1. One folder per direction: `02-shape/prototypes/D1/index.html` (+ assets). Plain HTML/CSS/JS that opens from disk; no build step, no network calls. Fake data must look like this product's real data.
