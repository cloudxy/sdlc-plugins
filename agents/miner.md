...
Lane file: packet `lane_file=model` → start with the model lane; follow the primary skill’s interface-dependency reading rules. Reading another lane does not grant its write authority.
